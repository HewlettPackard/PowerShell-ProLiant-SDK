...
for($i=0;$i -lt $ListOfAddress.Count; $i++)
{
    ...
    $connection = Connect-HPEBIOS -IP $ListOfAddress[$i] -Credential $Credential -BIOSAdminPassword $inputAdminPasswordList[$i].ToString() -DisableCertificateAuthentication


    if($connection -ne $null)
     {  
        Write-Host ""
        Write-Host ("Connection established to the server") -f $ListOfAddress[$i] -ForegroundColor Green
        $connection
    ...
    {
        Write-Host "Connection cannot be established to the server : "$ListOfAddress[$i] -ForegroundColor Red
    }
} 
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA6Wyjv4zz9J9s4
# xAlqGQttHGXLDlkjeZGKRl11zBLUVaCCHhkwggViMIIESqADAgECAhEA1HaTOoqh
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIP8njYZJtWF6gGmT3tZp9RpM
# NG2EHqRFf+13bTnWWOzkMA0GCSqGSIb3DQEBAQUABIIBAArJIKzT5nnSpOnDySUT
# IIyY5ydz+UXy4Lt2aURnQTWpl7El8eFb3PMXmdA/J6slwLUSskvYJhk0Mq39b6ic
# ezwDLiZ2ElGUjznXHfS+vSx7gVxKsBDF978lw0YR64eugT71Z/t4L8JSNa8Wvt6V
# pW0EMox4mEWMobRcGcioA6jKOXYsZmOiDAAaqq5SR3OumY+RP4tklN3CTFvZu5tN
# iyOOuSvwe+i5lC4FKckL499CbSMp5UMzHAlrzsL44eLUDsf6TefsHbzLACPiUshF
# kJBZlp9dBR4pMIHbOgztrwoNACGTTPt8tQ617YSU1lj4PDOJzZsusRaCYLx0sGdM
# I5ihggIPMIICCwYJKoZIhvcNAQkGMYIB/DCCAfgCAQEwdjBiMQswCQYDVQQGEwJV
...
# HAYJKoZIhvcNAQkFMQ8XDTIwMDUxODEyMDQ0MFowIwYJKoZIhvcNAQkEMRYEFIyu
# uCiT3RxVtMfRuVWCIUdqXSJ1MA0GCSqGSIb3DQEBAQUABIIBAHKLAPLsimWvjx+I
# KS2n2EKgZQ8ynrS7+e87MUTWJ55AROPK1I+cdwETvfvcAhG7yS16th28vvEu6bIe
# nDGYHQElxxdkl4WcEcwTwP+8un0jwR52nLBPOlm0MmZo7AFJNxIcYg1ywjo8Dr1z
# yxTYglY4iOejcoSN34k8HI2fvTVZ2JzpFvqRR37QCkyldAARIRo9eqzmVZ3r3W4y
# Rei70My9q51fGn0K2cExXwU/uPomgQDdMqUuOU44GXTra0T1SifQiKiTPjDrivqj
# thdW1W5t2tRgk8mOlkY95zd2JCPrjDqlRCn0yz+lQw7/0dXAk9HIQJRTIj4cbuKJ
# Ix8+Mkg=
