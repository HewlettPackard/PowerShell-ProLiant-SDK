...
<#
.Synopsis
    This script allows user to change core performance boosting on HPE Proliant Gen10/Gen10 Plus servers with AMD processors.
...
foreach($IPAddress in $ListOfAddress)
{
    ...
    if($connection -ne $null)
     {  
        ...
        $connection
        if($connection.TargetInfo.ProductName.Contains("Gen10") -and $connection.TargetInfo.ProcessorName.Contains("AMD"))
        {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDTTxY0O1n4WwQg
# 7CMxE7SyYfRwK2zPzuTLIZ3zTDdFlqCCH04wggSEMIIDbKADAgECAhBCGvKUCYQZ
...
# MSIEIHEp0IdMEOgSZtZRDJnmLBo7GiATCbUWHKlldlP1wAo0MA0GCSqGSIb3DQEB
# AQUABIIBAC9Vd4mJAjp6DLbMn63qlvSkccLT/ryqRck0rriYS1YrkE74FJlxfR6p
# H43Ux5EF4NQtr7EUYFk2a1RHG7cyYELO6LIsBytRWAu1G9iA2CT8ZduJfgvKRPZ4
# ioMqC/OVHfyzR+jFLlTkKnspIBolIcxfdgN3r+VqLhB7Oe50sn1O/vykBA9yMQZI
# OFwxQWjOmQ3YYGYznWlYRa5+WkkkkZLijNKYnPMjQrKox6kXI2itMVBEbAUw/YPe
# g8aNatAq/LCWS5h7JJOeZZetL83egzZzZDQCPs7NvRGN1XqUgWD/GCE3qdD8hDPD
# atyhkS+2nmbDLntUfJY33zC/RtwCiPShggIoMIICJAYJKoZIhvcNAQkGMYICFTCC
...
# CSqGSIb3DQEJBTEPFw0yMDA1MTgxMTQ4NTdaMCMGCSqGSIb3DQEJBDEWBBTL09bT
# GKkzOxgnPk8cQXtuE4HyWDANBgkqhkiG9w0BAQEFAASCAQAriihmWLPubPb2NnHf
# 5yBHfU113tDk5j3E4A7fP7Ftwyd1IJXLOutAT5sx+l2P4IEhCKBz6vHUJ6ei+/4K
# qNwZ07rQYdLqXBnQIlJTH+jzHs6filA0MGxKQm9AjjRsBReQMT+paeeXZMlb07Xd
# rM3gzZGeJkZ7APzITqegVcn/jRBytzvfOA/ogUAEcw7kwwDMMj14GTOob5CO56Cf
# rbsYGa5kX2zabFZEdmJrSaGLAOTIyLdDDgEQNGQrvOoB6RzMwNL4hctsjiI2RinK
# j76I8CpMlkGXdtoa0MG6x2A71pEDrXq1hpUJdoY0plqQGAwXDYBfly0cpH5Icc6W
# Uz1H
