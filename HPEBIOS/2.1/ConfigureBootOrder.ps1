...
<#
.Synopsis
    This script allows user to change boot order of HPE Proliant Gen10 and Gen9 servers
...
.EXAMPLE
    ...
    -UEFIBootOrder:- Use this Parameter to specify boot order.Only the number of UEFI configured options available for a particular server can be entered as UEFIBootOrder parameter values.
                     The index values can be entered by referring the Current boot order settings.
...
Write-Host "This script demonstrate how to change UEFI boot order for Gen10\Gen9 server.The parameters it accepts are \n"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAheylzCnpXL5wc
# RjvntL5UmflkNSHFO15qWmzIXpjItaCCHtUwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# CisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIGrdZ18WCseqJceT4XOdzY1AUBPz
# 4g2Wyl85zlRLMgjnMA0GCSqGSIb3DQEBAQUABIIBABuQy7QeR1ydGjAEjep5dFOu
# o5B6XftF1qdIKgKQKtMD1xbYnt4HirYaJbv7VVSVUObrKENn0AsSH7mDjzkWND7/
# VIiMOirptxhYtiCVl6lzBctzrjCkL67u1kjU/JKHYhlKN93S/zWs6IZtQD8SZKlb
# sVEA9i2dR0ro/youGUQW+FZ94iUdy64j2l9EZShTYJwSzd8j7OMmNDTFNBuLUMUu
# r+GkOPh237dSqpMlQh1QX7q33h2JAkmTY49JYuZuQLqxkdZVkMiZ16oG+S/Ef6RV
# BjQJ0sQ965Et5LTxYsvPMv0FxdL19AyZ3LELCy1gLPQt8Ea+hwUb1z1MFLyL7yCh
...
# MTgwMzA5MTAwOTA2WjAjBgkqhkiG9w0BCQQxFgQURy/hr4Spi74d4DHu5dKfPOKU
# IacwgZ0GCyqGSIb3DQEJEAIMMYGNMIGKMIGHMIGEBBRjuC+rYfWDkJaVBQsAJJxQ
...
# ESHWmadklz7x+EJ+6RnMU0EUMA0GCSqGSIb3DQEBAQUABIIBAEq6ZkE0kGkkmlac
# j+d+SxiYQ0mTIUzOvxEixVbG8OSyPNTcx9Z9P3+iEfB3ggMungTpit1XD0ltHGSB
# Mp2e8MrUfzpQfkvFA/SpFL6QZIzGZyKL3enC6CC1q7IgLCTD6MtAbL6jNjg6xkYi
# XkR15GovfVyCOBuL6mQj4Nlz8Ym22u5SXuxbMgrwKIqiBrn64sNwCHEspdlfKt5L
# blr3Uj7UVZv5eaTehKA84T2LYsm84BuyLozmfFMgjd402jYcj/5RlLIMMEbjao1H
# ii8+wiv1ImakxUTESE3BO8iLajr9kI4J+DaqK+vTZ4ADTx0vikU78xCVpzfdQDHH
# AHG5zDA=
