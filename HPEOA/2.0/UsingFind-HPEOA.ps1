...
if($csv -ne $null)
{
   Find-HPEOA -Range $csv.IP -Role Active
}
else
{
...
<#
Discover OA through the specified range

Find-HPEOA -Range 192.168.1.1-255 -Role Active
...
#>
#Example 2: Piping output from Find-HPEOA to Connect-HPEOA,Get-HPEOAInfo
...
Connect-HPEOA 
 $OAConnection | Get-HPEOAInfo -Verbose
}

if($OAConnection -ne $null -and  $OAConnection.IsConnected)
{
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCu5FI4KqRA1l2j
# KmGVbwkQcDCIHThXui7v5J88uba+5KCCHtQwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# BgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCDi40hrgxkgyNFUrWLzJ/n9exKzmeLO
# xr9bViOyzu3x7TANBgkqhkiG9w0BAQEFAASCAQBx3lxQoz/XLX22s1bQgJgtPR2M
# Pcxv5czQEgKPLuiO+te+YikejsH/VXD9FmNBBL90LTxoIDfuLMZ7ElZVNs9EZfRs
# 8HD0GFXLx0y7dJmEgvJYR6ez+tHAiIV73oVVq3pezRhNpBWXCwPib2cPJPK7ib5l
# UgIlvUpmySvbJXcj79kJVSecfHShvJLUVk+O8aFdrPuoZ8ruDO6Fm7TxCComoD2d
# 3dkcT2CMCkeaAXLxj0i6axrpirPvHO/xHOfgYBoE5ZPLfe1wr2WpQr/hpEuTEGF/
# s/4WnbSW6nJ1MzW+WWAgHEhheNBO2QxmOEwbCbUZsDb867PiwdAAP4Gkp/30oYIC
# ojCCAp4GCSqGSIb3DQEJBjGCAo8wggKLAgEBMGgwUjELMAkGA1UEBhMCQkUxGTAX
# BgNVBAoTEEdsb2JhbFNpZ24gbnYtc2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGlt
# ZXN0YW1waW5nIENBIC0gRzICEhEh1pmnZJc+8fhCfukZzFNBFDAJBgUrDgMCGgUA
# oIH9MBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE4
# MDgwMjA1MTk1NVowIwYJKoZIhvcNAQkEMRYEFA8RHdHbv7Z8c144bH1FPZmx1W78
# MIGdBgsqhkiG9w0BCRACDDGBjTCBijCBhzCBhAQUY7gvq2H1g5CWlQULACScUCkz
# 7HkwbDBWpFQwUjELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYt
# c2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gRzICEhEh
# 1pmnZJc+8fhCfukZzFNBFDANBgkqhkiG9w0BAQEFAASCAQB2fzQP7dExIsrY0VZu
# 2k/l+Ti7tjNh9YSl69xXW5vuK5MtCNBOvKgZU6/gpqq3VMTUPetfMET8s2p8wyFh
# scXTJ+bA4EApB7dYz03Shua+tGn/EX+C6PnqEoZ7mabaqGI/UZT5tJSiq06Dyse2
# 1yDXAGUOgfTJ9GhPAtO8pkkXNK8jWNexNM8ukPrJtVa7fjbxGS37s1NUoM+H8d9l
# 8Sxk3LD+vDpSnYZl3uyFi5POfcLHEA9B/9FU49oh/Np8pBPU6GTVown+tEftPkcI
# KLINyqFfCVLk6iTQ2qIaVNVK1ZgvrRqk+Gx1neqGhOT1CyUY2/Grfj1+gdgNnlKj
# BhZe
