...
try{
    ...
    {
        Write-Host "Unable to connect to the target OA" -ForegroundColor Red
        exit
    }
    Write-Host "Configuring Interconnect IP Address and Netmask" -ForegroundColor Yellow
    $interconnectIP = Read-Host "Eneter Interconnect IP Address`t"
    $interconnectNetmask = Read-Host "Enter Netmask`t"
   # $bay = Read-Host "Enter bay number :`t"
    $rt = $connection | Set-HPEOAEBIPA -IP $interconnectIP -Target Interconnect -Netmask $interconnectNetmask
    if($rt -ne $null)
    {
    ...
    $rt = $connection | Get-HPEOAEBIPA
    $rt.EBIPADeviceInterconnectSettings
    Disconnect-HPEOA -Connection $connection
}
catch{
    $connection | Disconnect-HPEOA
    exit
}
# SIG # Begin signature block
# MIIkXwYJKoZIhvcNAQcCoIIkUDCCJEwCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCFJzM2NBh4GvRu
# 8bgqKCVjDiIKmG2vdzGq96NUBD2br6CCHtQwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# BgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCChbI1j8ehrcxXcjjNcql8xLrtqniGd
# Xzw8KSOWu9jl1zANBgkqhkiG9w0BAQEFAASCAQA0y9NkMmeW4C5XFl/U7lryi+hP
# VCWM/Iw8eH/HS+BjHmpyB9Gp8kN9VM6GSdJf25P4IAFFTDDdkoy9VU7WDVgHLZ8P
# mxo1DQor/5j7zAF5ssIQEh/2wTvCiH6q7lyVZ3Y0AiOCmvD6gaqUsX9ZPTDIK5i8
# zq1OQcCjOKqRoUbUy7Do3hDIsdgMrgYfhS3PUPg4USxV1c5PU03kCzCjzI5kmb5d
# mj6fFygrC2POH4b+Hx1aGAwqGXmW7ypb2ROufQQNG5BD4p7v1MFrKvoiA/ESvSSa
# BccgmEnvmCwFOq0My408rrzw4WG4dIreBaxDHHpEQ/CIL9bJPxcEqdZfpcvaoYIC
# ojCCAp4GCSqGSIb3DQEJBjGCAo8wggKLAgEBMGgwUjELMAkGA1UEBhMCQkUxGTAX
# BgNVBAoTEEdsb2JhbFNpZ24gbnYtc2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGlt
# ZXN0YW1waW5nIENBIC0gRzICEhEh1pmnZJc+8fhCfukZzFNBFDAJBgUrDgMCGgUA
# oIH9MBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE4
# MDgwMjA1MTcwOFowIwYJKoZIhvcNAQkEMRYEFOG1oAsNxrAI3kF79JzC4ehF3kPI
# MIGdBgsqhkiG9w0BCRACDDGBjTCBijCBhzCBhAQUY7gvq2H1g5CWlQULACScUCkz
# 7HkwbDBWpFQwUjELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYt
# c2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gRzICEhEh
# 1pmnZJc+8fhCfukZzFNBFDANBgkqhkiG9w0BAQEFAASCAQAe0bBBKWdF805HNadb
# UcB5cPuNFB/Y4VbyAT3tBTaOfAeXyz+vKERMDqXTliSo7xSqJ//zd4W1SAnHXDYi
# KNRu+g1xOijtVS2MxA4DtfNl6dEXCoXbc46n0jo7KDgSQxiObRCciHo5eS7f5tbj
# JL4kjT2KSxskePnvy8d7TcEA5+BY2umxmg9+KFNL3qgZ4PTebAPOIi+1UpHFHM4h
# OVgcBksR8+oB3L445oQfOr/GyzrJLgr7bTR0nt7zK4WMdUgW1O+NPvgNLzTibtt8
# u36VNyJSh9v7ewD5szQRSgRZXNjUlz5V/vx2h/KUo2i1Q022l76bcCgJcNQttZoL
# VXaA
