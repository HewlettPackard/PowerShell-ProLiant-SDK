...
This script is an example of how to use Invoke-HPEOAiLOCommand to get or set the iLO configurations
...
# use below mentioned way to get command from iLO command
...
$command = 'Get-HPiLOLanguage
Add-LevelWithValueAndOther
GET_ALL_LANGUAGES
<RIBCL VERSION="2.30">
...
#Step2: Use "Find-HPEOA" to find available OAs and execute the Invoke-HPEOAiLOCommand on those OAs
...
if($csv -ne $null)
{
    ...
    Connect-HPEOA 
     ...
     $OAconnection | Invoke-HPEOAiLOCommand -iLOCommand $command -Bay All 
    }
}
else
{
...
if($OAconnection -ne $null)
{
    $OAconnection | Disconnect-HPEOA
}

# SIG # Begin signature block
# MIIjpgYJKoZIhvcNAQcCoIIjlzCCI5MCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAL1SyjA0z/moiY
# vuVPM6slTqotKSjkgTDOSSaIReYi3qCCHrIwggPuMIIDV6ADAgECAhB+k+v7fMZO
...
# BAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIMDsmi1YEqw5
# eVgViWTZXHdbrEIrv6pDkbG9k7SN96MrMA0GCSqGSIb3DQEBAQUABIIBAJVPo+r5
# K6F9nvxoSvMKCPP4MxWbISsquBVKKz+0exmF1+5RId/NRMoMhBYNIwSSnnib5IUV
# oXJh+qW/DwpHUxHr33gijhONGH2dsTgUSME4E0AqLFtGCe8Qyr9J79sIvl+MEfts
# 7RGMrm5FXAobg82+8osI3v5Gira6uySfaz173BMTVumGufSiqaZTDQsr7REvrdXv
# L5n4Y3JkSa96YjS9rFs/xlB/ZPHFMV8w1hDZkcS/KJpwgsNyYBJ/Yt5PB9tky6et
# zwpFc7Irm77ruooCTaRYAHDdRAxTbCNCqk772XrMwuh3ZBpvQuSrtgPeo67oOjOy
# 1ta/jvjQablcEU2hggILMIICBwYJKoZIhvcNAQkGMYIB+DCCAfQCAQEwcjBeMQsw
...
# DQEHATAcBgkqhkiG9w0BCQUxDxcNMTgwODAyMDUyMDEzWjAjBgkqhkiG9w0BCQQx
# FgQUnVfLulWXRy6FKRg+jHQDX+CCGUQwDQYJKoZIhvcNAQEBBQAEggEAB8pnyhHc
# O6TmpOXB2d2vvylnnKcU6jSBWkBKH50Dxvmve0ySCA1qVPnIKKKy2TdvFrJNG95g
# 93ucKmvFPuUqfBD5IjcidoNK2MKiP/QJjnyHep51fouxUhLDgHdQiIlm5cNBqmzz
# DseivsUB/5caRDDKzHRMyXUy6Dffa5Csc5ZPqitLB6JbwGBN0EXEFE3LYX93SaC7
# +t7RlB6QKDm3Bdht+cQJqqDpigicveXoqthyD+e0mSAX7snssX7TYtBsi8mBAOlY
# PXdS1pp0los2tfycg59vKz5X8nAlBHj5x9//D/xf5F/w8JIk1fFtj0DoU3NvzqdQ
# JZbzmZgExYoLSQ==
