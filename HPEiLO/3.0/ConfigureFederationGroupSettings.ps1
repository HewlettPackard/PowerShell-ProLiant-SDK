...
.EXAMPLE
    PS C:\HPEiLOCmdlets\Samples\> .\ConfigureFederationGroupSettings.ps1 -GroupName "GroupDemo" -GroupKey "demoKey" -MulticastScope Link -AnnouncementInterval 30 Yes -MulticastTTL 120
