...
try
{
    ...
    foreach($connect in $connection)
    {
        ...
        $cmdletName = "Enable-HPEiLOSecurityDashboardSetting"
        ...
        $cmdletName = "Disable-HPEiLOSecurityDashboardSetting"
        $expression = $cmdletName + " -connection $" + "connect" +$appendText
        $output = Invoke-Expression $expression
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCpkHs80vsoZ5BE
# bD7H2jlicBA9ynFRUVglqaanss5yiKCCHuUwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJ/4M4EK
# Fgae81i9EWURTeCzDoIDFHXS5lgEFydXd48mMA0GCSqGSIb3DQEBAQUABIIBAB+2
# Jon7JWUaWg9UpPwt8McdYcpQHjyvrAQBGqqy/YKUzeQKSHKVdUlkNFIO2TSg/udI
# It49djJa/4CFNgN5Ou72YLWNjsERlIG7FFVSR5TtFafaKmGLh8qybftwTn6p5h6o
# 3S8i29iDOXO2zkoGGZbKALYW/nwbOsk//UbIk8GHp3g7A3AXo+h6s/vK4dByjPjy
# 64KFGDc1KszaQLUoW2AN63sm/A2MXNGP5b+D6nqBiEmBdbfA16cWxKCUeezez2qd
# Uv02vhi/KSpBi2P0si4Vagz5fmdbuG5qk2K5n4cgDOutZ63y6ECduqIspYJamRcT
# LphqFzYRp2rtnK6sYcShggKiMIICngYJKoZIhvcNAQkGMYICjzCCAosCAQEwaDBS
...
# BgkqhkiG9w0BCQUxDxcNMTkwMzIxMDY0NzI3WjAjBgkqhkiG9w0BCQQxFgQU5lbC
# m05jjxzZU2+BEdkKp1bKJqowgZ0GCyqGSIb3DQEJEAIMMYGNMIGKMIGHMIGEBBRj
...
# BIIBAI4sw7/pQRHs0iPcwUNd8brsCp80FhAAfBjKqYN5EWi4PMJ4N8brEaMqihDw
# 754KDqlfwUgSOnPpkrgbjwL177WACqKDBK/yQL+eZq6JvHj30nf6bsEZJPw3KDYA
# 5PlaHOdY1aFxnQ5EJ+1XqEsbnnqt+ljUqwAdllOa3HAChlYZEIk5tx/O4FuAmGFx
# CX3kXjnRrsT4W5NwTkI2dmhefejwqdNhzuC2/7uiYJGAyvBWADEPoq8Uj/D8F+Ye
# llAtebX8pncUHuEi2Zamqtg6ufc9EvgDhYgV48GonoC+1bT7L1JnivxLF12ri2U1
# JDJUC5g5HG8QVrnzCQ+Mz1tR7Qs=
